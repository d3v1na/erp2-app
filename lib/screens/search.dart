            ...
            child: Padding(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  items: <String>['Select Subject', 'Computer Science', 'Electrical Engineering', 'English', 'History', 'Art', 'International Relations', 'Economics', 'Finance']
            ...
            child: Padding(
              ...
              child: TextField(
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: const Color(0xff545F71)),
                ),
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  items: <String>['Select Course Career', 'Undergraduate', 'Graduate']
                      .map<DropdownMenuItem<String>>((String value) {
                    return DropdownMenuItem<String>(
                      value: value,
                      child: Text(value, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: const Color(0xff545F71))),
            ...
            child: Padding(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  items: <String>['Select Course Attribute', 'IC Component', 'REAL Component', 'VELS Component']
                      .map<DropdownMenuItem<String>>((String value) {
                    return DropdownMenuItem<String>(
                      value: value,
                      child: Text(value, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: const Color(0xff545F71))),
